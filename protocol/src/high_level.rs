...
pub trait HighLevel : Clone + fmt::Debug {
    ...
    fn from_low_level(value: Self::LowLevel) -> Result<Self, Error>;
}
...
impl<H> Parcel for H
    ...
    fn read(read: &mut Read,
        ...
        let low_level = H::LowLevel::read(read, settings, hints)?;
        H::from_low_level(low_level)
    }
    ...
    fn write(&self,
        ...
        low_level.write(write, settings, hints)
    }
}
